...
public class ImageUtil {
	...
	public ImageUtil(BufferedImage image, int height, char imgChar) {
		ChatColor[][] chatColors = toChatColorArray(image, height);
		this.lines = toImgMessage(chatColors, imgChar);
	}

	public ImageUtil(ChatColor[][] chatColors, char imgChar) {
		this.lines = toImgMessage(chatColors, imgChar);
	}

	public ImageUtil(String... imgLines) {
		this.lines = imgLines;
	}

	public ImageUtil appendText(String... text) {
